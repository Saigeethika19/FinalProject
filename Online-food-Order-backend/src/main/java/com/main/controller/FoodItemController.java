...
public class FoodItemController {
	...
	@PostMapping("/saveMultiFoodItems")
	public ResponseEntity<List<FoodItem>>savedMultipleUser(@RequestBody List<FoodItem>foodItems)
	{
		List<FoodItem> foodItemsList = foodItemService.saveMultipleFoodItem(foodItems);
		return new ResponseEntity<List<FoodItem>>(foodItemsList,HttpStatus.OK);
	}
